...
public static class ScanBlockFeatureConfigDefaults
{
    ...
    /// </summary>
    public static readonly string[] PermanentlyAllowedHosts =
    [
    ...
    /// </summary>
    public static readonly string[] ForbiddenFullPaths =
    [
        // Php
    ...
    /// Must be url encoded.
    /// </summary>
    public static readonly string[] ForbiddenPartialPaths = [
        // SQL injection
    ...
    /// </summary>
    public static readonly string[] BadFileEndings = [
        // Web
        ".asp", ".aspx", ".php",
    ...
    /// </summary>
    public static readonly string[] BadPartialPaths = [
        // Directories
